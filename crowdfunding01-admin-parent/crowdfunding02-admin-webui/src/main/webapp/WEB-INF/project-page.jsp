...
<script type="text/javascript">
    ...
    $(function(){
        ...
        $("#removeRoleBtn").click(function(){
            ...
            $.ajax({
                "url":"project/remove/by/role/id/array.json",
                "type":"post",
                "data":requestBody,
        ...
        $("#checkremoveRoleBtn").click(function(){

            // 从全局变量范围获取roleIdArray，转换为JSON字符串
            var requestBody = JSON.stringify(window.projectIdArray);

            $.ajax({
                "url":"project/check/by/role/id/array.json",
                "type":"post",
                "data":requestBody,
                "contentType":"application/json;charset=UTF-8",
                "dataType":"json",
        ...
        $("#rolePageBody").on("click",".removeBtn",function(){
            ...
            // 从当前按钮出发获取角色名称
            var roleName = $(this).parent().prev().prev().prev().prev().prev().text();
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <button
                            type="button"
                            id="batchCheckBtn" class="btn btn-primary"
                            style="float: right;">
...
<%@include file="/WEB-INF/modal-project-confirm.jsp" %>
<%@include file="/WEB-INF/modal-project-check-confirm.jsp"%>
