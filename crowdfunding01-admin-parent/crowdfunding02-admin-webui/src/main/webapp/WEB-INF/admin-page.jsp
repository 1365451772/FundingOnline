...
<%--                                          <!--访问SecurityAdmin对象的属性：<security:authentication property="principal.originalAdmin.loginAcct"/>-->--%>
                                          <c:if test="${admin.loginAcct != sessionScope.SPRING_SECURITY_CONTEXT.authentication.principal.username}">
