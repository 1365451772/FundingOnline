...
import com.peng.crowd.entity.po.TagPO;
import com.peng.crowd.entity.po.TagPOExample;
...
public interface TagPOMapper {
    ...
    int updateByExampleSelective(@Param("record") TagPO record,
        @Param("example") TagPOExample example);
