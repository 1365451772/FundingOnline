...
public class CrowdUtil {
    ...
    /**
     * @param from     用于给用户发送邮件的邮箱
     * @param password 邮箱的密码
     * @param host     发送邮件的服务器地址
     * @param phoneNum 接收验证码的邮箱
     * @param title   邮件主题
     * @param skin     标签
     * @return com.peng.crowd.util.ResultEntity<java.lang.String>
     * @create 2021/5/4 21:32
     */
    public static ResultEntity<String> sendCodeByEmail(
            String from,
            String password,
            String host,
            String title,
        ...
        try {
            ...
            String content = "【crowdfunding】"+ code;
